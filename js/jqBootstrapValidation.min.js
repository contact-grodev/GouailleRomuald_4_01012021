                    ...
                    $this.bind(["keyup", "focus", "blur", "click", "keydown", "keypress", "change"].join(".validation ") + ".validation", function (e, params) {
                        ...
                        if (errorsFound.length) {
                            ...
                            if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                                ...
                                $helpBlock.html(
                                    '<ul class="list-unstyled alert alert-warning" role="alert"><li>' + errorsFound.join("</li><li>") + "</li></ul>" + (settings.options.prependExistingHelpBlock ? $helpBlock.data("original-contents") : "")
                                );
                            }
                        } else {
